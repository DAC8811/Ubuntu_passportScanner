    ...
    "includes" =>
        {
            ...
            "engines/afalg/e_afalg.o" =>
                [
                    "include",
                ],
            "engines/afalg/e_afalg_err.o" =>
                [
                    "include",
                ],
            "engines/e_capi.o" =>
