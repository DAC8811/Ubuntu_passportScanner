...
MVSDK_API unsigned char* __stdcall CameraAlignMalloc(
    int             size,
    int             align
    );
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraSetAutoConnect(CameraHandle hCamera,char bEnable);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraGetAutoConnect(CameraHandle hCamera,char *pbEnable);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraGetReConnectCounts(CameraHandle hCamera,unsigned int* puCounts);
...
MVSDK_API CameraSdkStatus __stdcall CameraSetSingleGrabMode(CameraHandle hCamera, char bEnable);
...
/// \return Returns CAMERA_STATUS_SUCCESS(0) successfully. Otherwise, it returns a non-zero error code. Please refer to the definition of the error code in CameraStatus.h.
MVSDK_API CameraSdkStatus __stdcall CameraGetSingleGrabMode(CameraHandle hCamera, char* pbEnable);
...
MVSDK_API CameraSdkStatus __stdcall CameraFlatFieldingCorrectSetParameter(
	CameraHandle hCamera,
	unsigned char const* pDarkFieldingImage,
	tSdkFrameHead const* pDarkFieldingFrInfo,
	unsigned char const* pLightFieldingImage,
...
MVSDK_API CameraSdkStatus __stdcall CameraManualDenoise3D(
	...
	unsigned char			**InFramesData,
	int				nCount,
	float			*Weights,
	tSdkFrameHead	*OutFrameHead,
	unsigned char			*OutFrameData
	);
...
MVSDK_API CameraSdkStatus __stdcall CameraReadDeadPixels(
	CameraHandle    hCamera,
	unsigned short*			pRows,
	unsigned short*			pCols,
	unsigned int*			pNumPixel
	);
...
MVSDK_API CameraSdkStatus __stdcall CameraConvertFrameBufferFormat(
	CameraHandle hCamera,
	unsigned char *pInFrameBuffer, 
	unsigned char *pOutFrameBuffer, 
	int outWidth,
	int outHeight,
	unsigned int outMediaType,
	tSdkFrameHead* pFrameHead
	);
