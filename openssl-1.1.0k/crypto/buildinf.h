...
static const char cflags[] = {
    ...
    '/','a','s','h','1','/','l','a','b','_','p','r','o','/','U','b',
    'u','n','t','u','_','1','6','_','p','a','s','s','p','o','r','t',
    'S','c','a','n','n','e','r','/','u','b','u','n','t','u','/','i',
    'n','s','t','a','l','l','/','s','s','l','\\','"','"',' ','-','D',
    'E','N','G','I','N','E','S','D','I','R','=','"','\\','"','/','h',
    'o','m','e','/','a','s','h','1','/','l','a','b','_','p','r','o',
    '/','U','b','u','n','t','u','_','1','6','_','p','a','s','s','p',
    'o','r','t','S','c','a','n','n','e','r','/','u','b','u','n','t',
    'u','/','i','n','s','t','a','l','l','/','l','i','b','/','e','n',
    'g','i','n','e','s','-','1','.','1','\\','"','"',' ',' ','-','f',
    'P','I','C',' ','-','f','f','a','s','t','-','m','a','t','h',' ',
    '-','f','t','r','e','e','-','v','e','c','t','o','r','i','z','e',
    ' ','-','f','l','t','o',' ','-','f','d','a','t','a','-','s','e',
    'c','t','i','o','n','s',' ','-','f','f','u','n','c','t','i','o',
    'n','-','s','e','c','t','i','o','n','s','\0'
};
#define PLATFORM "platform: linux-x86_64"
#define DATE "built on: Tue Apr 20 10:05:08 2021"
